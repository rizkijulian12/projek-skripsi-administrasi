        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Formulir Tambah Pelatihan</h3>
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        Isi detail pelatihan baru di bawah ini.
                    </p>
                    ...
                    <div class="mt-6">
                        <form method="POST" action="{{ route('pelatihan.store') }}">
                            ...
                            <div>
                                ...
                                <x-text-input id="nama_pelatihan" class="block mt-1 w-full" type="text" name="nama_pelatihan" :value="old('nama_pelatihan')" required autofocus />
                                <x-input-error :messages="$errors->get('nama_pelatihan')" class="mt-2" />
                            </div>

                            <div class="mt-4">
                                <x-input-label for="kode_pelatihan" :value="__('Kode Pelatihan')" />
                                <x-text-input id="kode_pelatihan" class="block mt-1 w-full" type="text" name="kode_pelatihan" :value="old('kode_pelatihan')" required />
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="tanggal_pelatihan" class="block mt-1 w-full" type="date" name="tanggal_pelatihan" :value="old('tanggal_pelatihan')" />
...
<div class="mt-4">
    <x-input-label for="nama_instruktur" :value="__('Nama Trainer')" />
    <x-text-input id="nama_instruktur" class="block mt-1 w-full" type="text" name="nama_instruktur" :value="old('nama_instruktur')" />
</div>
